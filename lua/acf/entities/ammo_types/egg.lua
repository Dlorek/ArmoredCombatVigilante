...
local Ammo  = Types.Register("EG", "APHE")
...
function Ammo:OnLoaded()
	...
	self.Description = "A deadly weapon, can be dangerous in right hands"
	self.Blacklist = {
		AC = true,
		AL = true,
		C = true,
...
function Ammo:GetDisplayData(Data)
	...
	local Display   = {
		BlastRadius = Data.FillerMass ^ 0.1,
		Fragments   = Fragments,
		FragMass    = FragMass / Fragments,
		FragVel     = (Data.FillerMass * ACF.HEPower * 100 / (FragMass / Fragments) / Fragments) ^ 0.5,
	}
...
function Ammo:BaseConvert(ToolData)
	...
	Data.Ricochet		= 0 --Base ricochet angle
