...
local Ammo  = Types.Register("NAPCR", "AP")


function Ammo:OnLoaded()
	Ammo.BaseClass.OnLoaded(self)

	self.Name		 = "Naval-Armor Piercing Composite Rigid"
	self.Model		 = "models/munitions/round_100mm_ap_shot.mdl"
	self.Description = "Naval hardened core munition designed for weapons in the 1940s."
